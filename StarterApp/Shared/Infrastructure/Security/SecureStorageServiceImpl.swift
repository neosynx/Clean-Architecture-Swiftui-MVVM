...
/// Storage type enumeration for protocol
...
final class SecureStorageServiceImpl: SecureStorageService {
    ...
    var StorageType: SecureStorageType.Type { SecureStorageType.self }
